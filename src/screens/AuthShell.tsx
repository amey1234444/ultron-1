...
export function AuthShell({ subtitle, children }: { subtitle: string; children: ReactNode }) {
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={{ minHeight: '100%', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16, paddingVertical: 28, backgroundColor: '#0A0A0A' }}
    >
      ...
      <View
        className="w-full max-w-sm overflow-hidden rounded-2xl border p-6"
      ...
      >
        <LinearGradient
          ...
          style={{ height: 3, width: 42, borderRadius: 999, marginBottom: 14 }}
        />
  ...
  return (
    <View className="mt-3 gap-1">
      ...
      <TextInput
        ...
        className="rounded-xl border border-line-dark px-4 py-2.5 text-[15px] text-ink"
        {...props}
      />
    </View>
  );
