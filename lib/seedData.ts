...
export function createSeedData(makeId: () => string): {
  ...
  const cards: CardNode[] = [
    ...
    processCard('seed-card-2', 'seed-rack-north-1', 3, 'RAV-01 DE Bearing Temp', 'RTD 3-wire', '°C', ['0', '150'], ['65', '78']),
    processCard('seed-card-rav-nde-temp', 'seed-rack-north-1', 4, 'RAV-01 NDE Bearing Temp', 'RTD 3-wire', '°C', ['0', '150'], ['65', '78']),
    processCard('seed-card-rav-material-temp', 'seed-rack-north-1', 5, 'RAV-01 Material Temp', 'RTD 3-wire', '°C', ['0', '150'], ['65', '78']),
